using Animals.Library; // this lets me use the dog class from animals.library 

// (in terminal from Animals.UI folder) dotnet add reference ../Animals.Library
// and, add "using Animals.Library;" 
using System;
...
namespace Animals.UI
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // accessing properties and methods of dog objects
            dog.Name = "Bill";
            dog.Breed = "Labrador";
            dog.Bark();

            Console.WriteLine(dog.Name + " the " + dog.Breed);
        }
    }
}
