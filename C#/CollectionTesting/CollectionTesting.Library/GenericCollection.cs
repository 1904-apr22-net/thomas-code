...
namespace CollectionTesting.Library
{
    ...
    // the most important in IEnumerable<T>. that one allows your class to be put in a foreach loop
    public class GenericCollection<T> : IEnumerable<T>
    {
        ...
        {
            // if we code no constructor on a class, it has a default constructor automatically.
            // it is public, with no parameters, and has no contents

            // as soon as we define any constuctor, the default one goes away
        }
